import pytest
from minimum_spanning_tree import prims_mst, kruskals_mst
from graph import Graph

@pytest.mark.parametrize("algorithm", [prims_mst, kruskals_mst])
@pytest.mark.parametrize("vertices, edges, expected_mst, expected_weight", [
    ...
    (['A', 'B', 'C', 'D', 'E'], [('A', 'B', 1), ('B', 'C', 2), ('C', 'D', 3), ('D', 'E', 4), ('A', 'C', 5), ('B', 'D', 6)], {frozenset({'A', 'B'}), frozenset({'B', 'C'}), frozenset({'C', 'D'}), frozenset({'D', 'E'})}, 10),
